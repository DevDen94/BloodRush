...
namespace MarsFPSKit
{
    ...
    public class Kit_DefaultInputManager : Kit_InputManagerBase
    {
        ...
        bool isEnemyZombie(Kit_PlayerBehaviour pb, DefaultInputData did, Kit_PlayerBehaviour enemyPlayer)
        {
            if (pb)
            {
                if (pb.main.currentPvPGameModeBehaviour)
        ...
        bool CanSeeZombie(Kit_PlayerBehaviour pb, DefaultInputData did, Kit_PlayerBehaviour enemyPlayer)
        {
            if (enemyPlayer)
            {
                RaycastHit hit;
