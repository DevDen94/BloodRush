...
namespace Dan.Demo
{
    ...
    {
        public static LeaderboardShowcase Instance;
        [Header("Gameplay:")]
        ...
        private void Start()
        {
            ...
            _playerScore = PlayerPrefs.GetInt("LeaderBoardScore");
            Load();
        ...
        public void Submit()
        {
            ...
            Leaderboards.DemoSceneLeaderboard.UploadNewEntry(PlayerPrefs.GetString("PlayerName"), _playerScore, Callback, ErrorCallback);
