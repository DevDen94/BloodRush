...
public class GoogleAdMobController : MonoBehaviour
{
    ...
    private BannerView _bannerView1;
    ...
    public void RequestBigBannerAd()
    {
        if (!PlayerPrefs.HasKey("IAPDone"))
        {
            ...
            // Create a 320x50 banner at top of the screen
            _bannerView1 = new BannerView(BigBannerId, AdSize.MediumRectangle, AdPosition.TopRight);

            // Add Event Handlers
            _bannerView1.OnAdLoaded += (sender, args) => OnBannerLoaded();
            _bannerView1.OnAdFailedToLoad += (sender, args) => OnBannerFailedToLoad();
            _bannerView1.OnAdOpening += (sender, args) => OnBannerOpening();
            _bannerView1.OnAdClosed += (sender, args) => OnBannerClosed();

            // Load a banner ad
            _bannerView1.LoadAd(CreateAdRequest());
        }
    }
