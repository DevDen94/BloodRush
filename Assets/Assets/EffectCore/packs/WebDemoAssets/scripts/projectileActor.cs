...
public class projectileActor : MonoBehaviour {
   ...
   // public ParticleSystem muzzleflare;
    ...
    {
        //Movement
        if(ControlFreak2.CF2Input.GetButton("Horizontal"))
        {
            if (ControlFreak2.CF2Input.GetAxis("Horizontal") < 0)
            {
        ...
        if (ControlFreak2.CF2Input.GetButtonDown("Fire2") || ControlFreak2.CF2Input.GetKeyDown(KeyCode.E))
        {
            Switch(1);
        }
