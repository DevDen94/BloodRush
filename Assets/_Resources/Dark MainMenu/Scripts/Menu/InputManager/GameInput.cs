...
public class GameInput : MonoBehaviour {
	...
	{
		return ControlFreak2.CF2Input.GetKey(FindKey(name));
	}

	public bool GetKeyDown(string name)
	{
		return ControlFreak2.CF2Input.GetKeyDown(FindKey(name));
	}

	public bool GetKeyUp(string name)
	{
		return ControlFreak2.CF2Input.GetKeyUp(FindKey(name));
	}
