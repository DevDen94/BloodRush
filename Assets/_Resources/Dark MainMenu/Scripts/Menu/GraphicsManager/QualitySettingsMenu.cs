...
public class QualitySettingsMenu : MonoBehaviour {
	...
	void Load()
	{
		...
		fullscreenToggle.isOn = ControlFreak2.CFScreen.fullScreen;
	}
	...
	void ApplySettings()
	{
		...
		ControlFreak2.CFScreen.SetResolution(resolutionsList[resolutions.value].width, resolutionsList[resolutions.value].height, fullscreenToggle.isOn);
		Save();
	}
